...
@section('filtrarfutas')
      ...
      <div class="container justify-content-center">
				...
				<div class="" style="margin-left: 22%;">
					<span class=" badge badge-pill badge-primary" style=" font-size: 20px;">Filtrar frutas</span>
				</div>
									...
									<td>
											...
											<div class='row justify-content-center mt-3'>
												@if ($fruta->imagem)
													...
													<img src="{{ $fruta->imagem }}" class='img-fluid mb-3 d-block img200-200' alt="Imagem do Item">
												@else
