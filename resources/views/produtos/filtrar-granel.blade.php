...
@section('title') {{'filtrar-frutas'}} @endsection

@section('filtrarfutas')
      ...
      <div class="container justify-content-center">
				...
				<div class="" style="margin-left: 22%;">
					<span class=" badge badge-pill badge-primary" style=" font-size: 20px;">Filtra granel</span>
				</div>
				...
				@if ($granel->count() > 0)
					<table class="table table-bordered">
						...
						<tbody>
							@foreach ($granel as $granel)
								<tr>
								
									<td>{{ $granel->coditem }}</td>
									<td>{{ $granel->nome }}</td>
									<td>
											...
											<div class='row justify-content-center mt-3'>
												@if ($granel->imagem)
													...
													<img src="{{ $granel->imagem }}" class='img-fluid mb-3 d-block img200-200' alt="Imagem do Item">
												@else
