...
<head>
  ...
  <title>Nagumo Admin - Cadastro</title>
    ...
    <div class="card o-hidden border-0 shadow-lg my-5">
      <div class="card-body p-0">
        ...
        <div class="row">
          ...
          <div class="col-lg-7" style="background-image: url('https://nagumo.marketingonline.click/public/vendor/img/fundofrutaslayout2-.jpg');">
            <div class="p-5">
              ...
              <form action="{{ route('register.save') }}" method="POST" class="user">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input name="password_confirmation" type="password" class="form-control form-control-user @error('password_confirmation')is-invalid @enderror" id="exampleRepeatPassword" placeholder="Repeta Senha">
              ...
              <hr>
              <div class="text-center">
                <a class="small" href="{{ route('login') }}">já tem uma conta? Conecte-se!</a><br>
